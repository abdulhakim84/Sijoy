...
// Tambahkan header komponen wajah netral kita di sini
...
void Application::Initialize() {
    ...
    // 1. ISI LOGIKA INSIALISASI DISPLAY ADAFRUIT KITA
    initFaceDisplay();
...
void Application::Run() {
    ...
    while (true) {
        ...
        // 2. JALANKAN LOGIKA UPDATE FISIKA & RENDER ANIMASI WAJAH DI SETIAP LOOP
        updateFacePhysics();
        updateLook();
        updateBlink();
        renderFaceLoop();
...
void Application::InitializeProtocol() {
    ...
    protocol_->OnIncomingJson([this](const cJSON* root) {
        ...
        if (strcmp(type->valuestring, "tts") == 0) {
            ...
            // ====================================================
            // 3. PROSES STRINGS EMOSI DARI SERVER LLM
            // ====================================================
