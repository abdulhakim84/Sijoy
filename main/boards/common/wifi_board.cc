...
// PERUBAHAN: Mengubah durasi pencarian Wi-Fi dari 60 detik menjadi 15 detik (Logika luby.ino)
...
void WifiBoard::TryWifiConnect() {
    ...
    if (have_ssid) {
        // PERUBAHAN: Log monitor pelacakan durasi Wi-Fi dalam Bahasa Indonesia
        ESP_LOGI(TAG, "Mencoba menyambung ke Wi-Fi lama (Batas waktu: %d detik)...", CONNECT_TIMEOUT_SEC);
...
// PERUBAHAN: Menyesuaikan penanganan RTO/Batas waktu agar otomatis memicu Mode AP tanpa menggantung
void WifiBoard::OnWifiConnectTimeout(void* arg) {
    auto* board = static_cast<WifiBoard*>(arg);
    ESP_LOGE(TAG, "Wi-Fi lama tidak ditemukan! Otomatis beralih ke Mode AP...");
